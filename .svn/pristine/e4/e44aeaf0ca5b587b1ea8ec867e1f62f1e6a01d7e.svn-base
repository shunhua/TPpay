                            ...
                            <div class="panel-body">
                                <form class="layui-form form-container form-ajax form-horizontal" action="<?php echo U('Index/Home/tx');?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" value="<?php echo ($nowmoney); ?>" disabled="" type="text">（最小提现额度<?php echo ($config["minpay"]); ?>元）
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php if($ka == null): ?>* 没有银行卡？ <a href="<?php echo U('Index/Home/yhkadd');?>">添加银行卡</a><?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">
