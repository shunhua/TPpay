                            ...
                            <form id="J_Date" class="layui-form layui-form-pane form-inline" action="" method="get">
                                ...
                                <div class="form-group">
                                    <select name="status" class="layui-btn-small ajax-action form-control"  >
                                        <?php if(is_array($zt)): $i = 0; $__LIST__ = $zt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($_REQUEST['status']== $key): ?>selected="selected"<?php endif; ?>><?php echo ($n); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="set set0 table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <td colspan="10">
                                            <button class="btn btn-danger anniu delbtn" type="button" data-url="<?php echo U('Pay/save',array('status'=>0));?>">未支付</button>
                                            <button class="btn btn-danger anniu delbtn" type="button" data-url="<?php echo U('Pay/save',array('status'=>1));?>">已支付</button>
                                            <button class="btn btn-danger anniu delbtn" type="button" data-url="<?php echo U('Pay/save',array('status'=>2));?>">冻结</button>
                                ...
                                <tbody>
                                    <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($n["id"]); ?>" >
                                        ...
                                        <td align="center">开户名:<?php echo ($n["realname"]); ?> 账户:<?php echo ($n["ka"]); ?> 开户行:<?php echo ($n["address"]); ?></td>
