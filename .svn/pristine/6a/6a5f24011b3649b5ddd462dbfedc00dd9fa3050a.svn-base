                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="layui-form layui-form-pane form-inline" action="" method="get">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="username" placeholder="用户账户"  value="<?php echo ($_REQUEST['username']); ?>" size="12" type="text">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select name="ifagent" class="layui-btn-small ajax-action form-control"  >
                                            ...
                                            <option value="0" <?php if($_REQUEST['ifagent']== '0'): ?>selected="selected"<?php endif; ?>>否</option>
                                            <option value="1" <?php if($_REQUEST['ifagent']== '1'): ?>selected="selected"<?php endif; ?>>是</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="agent" placeholder="代理id" value="<?php echo ($_REQUEST['agent']); ?>" size="12" type="text">
                                </div>
                        ...
                        <div class="set set0 table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <td colspan="10">
                                            <button class="btn btn-danger anniu delbtn" type="button" data-url="<?php echo U('User/delete');?>">删除</button>
                                            <button class="btn btn-success anniu addbtn" type="button" data-url="<?php echo U('User/add');?>">添加</button>
                                ...
                                <tbody>
                                    <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($n["id"]); ?>" >
                                        ...
                                        <td align="center"><a href="<?php echo U('User/edit',array('id'=>$n['id'],'p'=>$_GET['p']));?>"><?php echo ($n["userid"]); ?></a></td>
                                        ...
                                        <td align="center"><?php echo ($n["money"]); ?></td>
                                        <td align="center"><?php echo ($n["tx"]); ?></td>
                                        <td align="center"><?php if($n['status'] == '0'): ?>正常<?php else: ?><font color="ff0000">锁定</font><?php endif; ?></td>
                                        <td align="center"><?php echo ($n["ifagent"]); ?></td>
                                        <td align="center"><?php echo ($n["agent"]); ?></td>
                                        <td align="center">
                                            <a href="<?php echo U('User/edit',array('id'=>$n['id'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                            <a href="javascript:;" data-id="<?php echo ($n["id"]); ?>" data-url="<?php echo U('User/delete',array('id'=>$n['id'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                                        </td>
