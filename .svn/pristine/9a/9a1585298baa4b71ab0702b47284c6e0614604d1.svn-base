                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="layui-form layui-form-pane form-inline" action="" method="get">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" name="qq" placeholder="qq" value="<?php echo ($_REQUEST['qq']); ?>" size="12" type="text">
                                    </div>
                                    <div class="form-group">
                                        <select name="ifcheck" class="layui-btn-small ajax-action form-control"  >
                                            <option value="">所有状态</option>
                                            <option value="0" <?php if($_REQUEST['ifcheck']== '0'): ?>selected="selected"<?php endif; ?>>正常</option>
                                            <option value="1" <?php if($_REQUEST['ifcheck']== '1'): ?>selected="selected"<?php endif; ?>>锁定</option>
                                        </select>
                                    </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($n["id"]); ?>" >
                                                ...
                                                <td align="center"><?php echo ($n["qq"]); ?></td>
