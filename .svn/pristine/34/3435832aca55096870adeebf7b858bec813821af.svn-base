                        ...
                        <div class="set set0 table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <td colspan="10">
                                            <button class="btn btn-danger anniu delbtn" type="button" data-url="<?php echo U('Agent/delete');?>">删除</button>
                                            <button class="btn btn-success anniu addbtn" type="button" data-url="<?php echo U('Agent/add');?>">添加</button>
                                    ...
                                    <tr class="info">
                                        ...
                                        <th align="center">达到金额</th>
                                        <th align="center">费率</th>
                                        <th align="center">操作</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($n["dlid"]); ?>" >
                                        <td align="center"><input type="checkbox" class="thisid checkbox" title="<?php echo ($n["dlid"]); ?>" name="thisid[]" value="<?php echo ($n["dlid"]); ?>"/></td>
                                        <td align="center"><a href="<?php echo U('Agent/edit',array('dlid'=>$n['dlid'],'p'=>$_GET['p']));?>"><?php echo ($n["dlname"]); ?></a></td>
                                        <td align="center"><?php echo ($n["money"]); ?>元</td>
                                        <td align="center"><?php echo ($n["fl"]); ?>%</td>
                                        <td align="center">
                                            <a href="<?php echo U('Agent/edit',array('id'=>$n['dlid'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                            <a href="javascript:;" data-id="<?php echo ($n["dlid"]); ?>" data-url="<?php echo U('Agent/delete',array('id'=>$n['dlid'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                                        </td>
