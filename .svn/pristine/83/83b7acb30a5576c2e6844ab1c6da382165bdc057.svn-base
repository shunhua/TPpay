                        ...
                        <div class="panel-body">
                            <form id="J_Date" class="layui-form layui-form-pane form-inline" action="" method="get">
                                <div class="form-group">
                                    <input class="form-control" name="userid" placeholder="管理员或用户id" value="<?php echo ($_REQUEST['userid']); ?>" size="12" type="text">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="content" placeholder="内容"  value="<?php echo ($_REQUEST['content']); ?>" size="12" type="text">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="module" placeholder="模块" value="<?php echo ($_REQUEST['module']); ?>" size="12" type="text">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select name="ifadmin" class="layui-btn-small ajax-action form-control"  >
                                            ...
                                            <option value="0" <?php if($_REQUEST['ifadmin']== '0'): ?>selected="selected"<?php endif; ?>>用户</option>
                        ...
                        <div class="set set0 table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <td colspan="10">
                                            <button class="btn btn-danger anniu delbtn" type="button" data-url="<?php echo U('Log/delete');?>">删除</button>
                                ...
                                <tbody>
                                    <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($n["id"]); ?>" >
                                        ...
                                        <td align="center"><?php echo ($n["module"]); ?></td>
                                        <td align="center"><?php echo ($n["content"]); ?></td>
                                        <td align="center"><?php echo (date("Y-m-d H:i:s",$n["addtime"])); ?></td>
                                        <td align="center"><?php echo ($n["ip"]); ?></td>
                                        <td align="center">
                                            <a href="javascript:;" data-id="<?php echo ($n["id"]); ?>" data-url="<?php echo U('Log/delete',array('id'=>$n['id'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                                        </td>
