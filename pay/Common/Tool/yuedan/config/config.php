...
class Config{
    ...
    //     'url'=>'https://qr-test2.chinaums.com/netpay-route-server/api/',	//支付请求url，无需更改
    //     'msgType'=>'bills.getQRCode',	//消息类型	
    //     'msgSrc'=>'WWW.TEST.COM',       //消息来源(msgSrc)
    //     'instMid'=>'QRPAYDEFAULT',       //机构商户号(instMid)
    //     'msgSrcId'=>'3194',             //来源编号（msgSrcId）
    //     'md5key'=>'fcAmtnx7MwismjWNhNKdHC44mNXtnEQeJkRrhKJwyrW2ysRR',             //MD5密钥
    //     'tid'=>'88880001'			    //终端号(tid)	测试数据
    //    );
    private $config = array(
        'url'=>'https://qr.chinaums.com/netpay-route-server/api/',    //支付请求url，无需更改
        'msgType'=>'bills.getQRCode',   //消息类型  
        'msgSrc'=>'WWW.HONGHMY.COM',       //消息来源(msgSrc)
        'instMid'=>'QRPAYDEFAULT',       //机构商户号(instMid)
        'msgSrcId'=>'4502',             //来源编号（msgSrcId）
        'md5key'=>'HXjMxF2EiT8yRCGjZ25Fza5f4FpAARRCfDBzs4sm5AYbf4Yj',             //MD5密钥
        'tid'=>'88880001'               //终端号(tid)  测试数据
    );
    ...
    public $RandomQuotes = array(
        //array('appid'=>'898420152113079','tid'=>'51140609'),
