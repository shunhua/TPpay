...
class Config{
    private $config = array(
        ...
        'msgSrc'=>'WWW.WHJDZRSM.COM',// 'WWW.TEST.COM',      //消息来源(msgSrc)
        'instMid'=>'H5DEFAULT',       //机构商户号(instMid)
        'msgSrcId'=>'4410',//'3194',             //来源编号（msgSrcId）
        'md5key'=>'bjSHKxG5D7ZXJkmZRrxJMC7DZzXc7pGAGhfM5iWeSwdrRP8R',//'fcAmtnx7MwismjWNhNKdHC44mNXtnEQeJkRrhKJwyrW2ysRR',             //MD5密钥
