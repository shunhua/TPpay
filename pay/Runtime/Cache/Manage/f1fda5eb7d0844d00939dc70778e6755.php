...
<div id="main">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="layui-form form-container form-ajax form-horizontal" action="<?php echo U('Agent/save');?>" method="post">
                <div class="form-group">
                    <label class="col-md-2 control-label">
                        代理名称：
                    </label>
                    <div class="col-md-4">
                        <input type="text" class="form-control"  name="dlname" value="<?php echo ($edit["dlname"]); ?>" required lay-verify="required" placeholder="请输入代理名称" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="money" value="<?php echo ($edit["money"]); ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="fl" value="<?php echo ($edit["fl"]); ?>" />
                        *例如费率0.5%这里输入0.5
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-4">
                         ...
                         <input type="hidden" class="form-control" name="dlid" value="<?php echo ($edit["dlid"]); ?>"/>
