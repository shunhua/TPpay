            ...
            <div class="col-md-10">
                <div class="right-content">
                    <div class="panel panel-default">
                        ...
                        <form class="layui-form form-container form-ajax form-horizontal" action="<?php echo U('User/fl');?>" method="post">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" disabled='' name="username" value="<?php echo ($edit["username"]); ?>" required lay-verify="required" placeholder="请输入用户账户" />
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <table class="table table-hover">
                                        ...
                                        <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr>
                                            <td><?php echo ($n["jkname"]); ?><input name="jkid[]" type="hidden" value="<?php echo ($n["jkid"]); ?>"/></td>
                                            <td>
                                                <select name="flselect_<?php echo ($n["jkid"]); ?>" class="form-control flselect">
                                                    <option value="0" <?php if($n["fl"] == 0 || $n["fl"] == null): ?>selected="selected"<?php endif; ?>>系统默认</option>
                                                    <option value="1" <?php if($n["fl"] > 0): ?>selected="selected"<?php endif; ?>>自定义</option>
                                                </select>
                                                <span <?php if($n["fl"] == 0 || $n["fl"] == null): ?>style="display:none;"<?php endif; ?>>
                                                    <input name="fl_<?php echo ($n["jkid"]); ?>" class="form-control" type="text"  value="<?php echo ($n["fl"]); ?>"/>
                                                </span>
                                            </td>
