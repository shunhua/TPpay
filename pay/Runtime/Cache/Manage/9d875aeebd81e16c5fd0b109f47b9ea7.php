...
<div id="main">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="layui-form form-container form-ajax form-horizontal" action="<?php echo U('Admin/pass');?>" method="post">
                <div class="form-group">
                    <label class="col-md-2 control-label">
                        管理员账户：
                    </label>
                    <div class="col-md-4">
                        <input type="text" class="form-control" disabled='' name="adminname" value="<?php echo ($edit["adminname"]); ?>" required lay-verify="required" placeholder="请输入管理员账户" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
