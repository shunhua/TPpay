...
<div id="main">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="layui-form form-container form-ajax form-horizontal" action="<?php echo U('Admin/save');?>" method="post">
                <div class="form-group">
                    <label class="col-md-2 control-label">
                        管理员账户：
                    </label>
                    <div class="col-md-4">
                        <input type="text" class="form-control" <?php if($act == 'edit'): ?>disabled=''<?php endif; ?> name="adminname" value="<?php echo ($edit["adminname"]); ?>" required lay-verify="required" placeholder="请输入管理员账户" />
                    </div>
                </div>
                <?php if($edit["adminid"] == '1'): ?><div class="form-group">
                    <label class="col-md-2 control-label">
                        原密码：
                    </label>
                    <div class="col-md-4">
                        <input type="password" class="form-control" name="passwordy" value="" />
                        * 不修改请留空
                    </div>
                </div><?php endif; ?>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="password" class="form-control" name="password" value="" />
                         <?php if($edit["adminid"] != null): ?>* 不修改请留空<?php endif; ?>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="realname" value="<?php echo ($edit["realname"]); ?>" required lay-verify="required" placeholder="请输入真实姓名" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="phone" value="<?php echo ($edit["phone"]); ?>" required lay-verify="required" placeholder="请输入手机号" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="email" value="<?php echo ($edit["email"]); ?>" required lay-verify="required" placeholder="请输入邮箱" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
                    ...
                    <div class="col-md-4">
                        <select name="status" class="form-control flselect">
                            <option value="0" <?php if($edit["status"] == '0'): ?>selected="selected"<?php endif; ?>>启用</option>
                            <option value="1" <?php if($edit["status"] == '1'): ?>selected="selected"<?php endif; ?>>禁用</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-4">
                         ...
                         <input type="hidden" class="form-control" name="adminid" value="<?php echo ($edit["adminid"]); ?>"/>
