                        ...
                        <div class="set set0 table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <td colspan="10">
                                            <button class="btn btn-danger anniu delbtn" type="button" data-url="<?php echo U('Api/delete');?>">删除</button>
                                            <button class="btn btn-success anniu addbtn" type="button" data-url="<?php echo U('Api/add');?>">添加</button>
                                ...
                                <tbody>
                                    <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($n["jkid"]); ?>" >
                                        <td align="center"><input type="checkbox" class="thisid checkbox" title="<?php echo ($n["jkid"]); ?>" name="thisid[]" value="<?php echo ($n["jkid"]); ?>"/></td>
                                        <td align="center"><a href="<?php echo U('Api/edit',array('id'=>$n['jkid'],'p'=>$_GET['p']));?>"><?php echo ($n["jkid"]); ?></a></td>
                                        <td align="center"><?php echo ($n["jkname"]); ?></td>
                                        <td align="center"><?php echo ($n["jkstyle"]); ?></td>
                                        <td align="center">
                                            <a href="<?php echo U('Api/edit',array('id'=>$n['jkid'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                            <a href="javascript:;" data-id="<?php echo ($n["jkid"]); ?>" data-url="<?php echo U('Api/delete',array('id'=>$n['jkid'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                                        </td>
