                ...
                <div class="right-content">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="layui-form form-container form-ajax form-horizontal" action="<?php echo U('Kou/save');?>" method="post">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">
                                        用户id：
                                    </label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="userid" value="<?php echo ($edit["userid"]); ?>" required lay-verify="required" placeholder="请输入用户id" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="initval" value="<?php echo ($edit["initval"]); ?>" required lay-verify="required" placeholder="请输入初始值" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="zijian" value="<?php echo ($edit["zijian"]); ?>" required lay-verify="required" placeholder="请输入计数值" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-md-4">
                                        <input type="hidden" class="form-control" name="act" value="<?php echo ($act); ?>"/>
                                        <input type="hidden" class="form-control" name="zjid" value="<?php echo ($edit["zjid"]); ?>"/>
