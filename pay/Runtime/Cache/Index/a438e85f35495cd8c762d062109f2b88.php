                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <td colspan="10">
                                                    <button class="btn btn-success anniu addbtn" type="button" data-url="<?php echo U('Index/Home/yhkadd');?>">添加账户</button>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($n["id"]); ?>" >
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo U('Index/Home/yhkadd',array('id'=>$n['id'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                                    <a href="javascript:;" data-id="<?php echo ($n["id"]); ?>" data-url="<?php echo U('Index/Home/yhk',array('id'=>$n['id'],'p'=>$_GET['p']));?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                                                </td>
